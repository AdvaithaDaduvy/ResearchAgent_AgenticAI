...
//     if (pdfFiles.length === 0 || !question.trim()) {
//       alert('Please upload at least one PDF and enter a question.');
//       return;
//     }
...
//       {result && (
//         <div className="mt-6 max-w-xl w-full bg-white p-4 rounded-xl shadow-sm border">
